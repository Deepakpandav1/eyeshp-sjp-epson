...
const HomePage = () => {
  return (
    <>
      <SEO />
      <h1>Welcome to Dr. Preeti's Bright Eye Care Hospital</h1>
      <p>We are committed to providing world-class eye care...</p>
    </>
  );
};
    ...
    <div className=" bg-[url('/public/bg-100-vh.jpg')] bg-fixed   landing-page-div mt-18">
      ...
      <div className="bg-cyan-950 py-2 overflow-hidden whitespace-nowrap">
        <div className="flex animate-marquee text-teal-300 font-bold">
          🚀 &nbsp;THOTA-approved Eye Hospital — Approved by Punjab Govt. | Regd
          No.: DPBECH(P)-CT(N)-PB-2025-5ME3/12737 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ✅ &nbsp; First Organ/Tissue
          Transplantation – Corneal Transplantation Center in Pathankot, Punjab
        </div>
      ...
      <div className=" py-30  m-0 flex items-center justify-center">
        <div className="text-center px-4 max-w-4xl">
          ...
          <p className="text-xl font-medium text-black text-justify">
            ...
            with precision and compassion. With expertise from top institutions
            and a full-time focus on patient care, our team works together to
            provide comprehensive, multi-specialty treatment. We believe in
            collaboration, innovation, and putting every patient at the center
            of everything we do.
          </p>
        </div>
      </div>
